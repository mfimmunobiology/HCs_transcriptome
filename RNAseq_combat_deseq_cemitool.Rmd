...
for (comp in comparisons) {
  tryCatch({
      ...
      test <- parts[2]
      # Define the contrast
      contrast <- c("Group", test, control)  # Assuming "Group" is the column in colData used for grouping
...
gene_sets <- read_gmt("/home/vivischuch/Documents/genesets/ReactomePathwaysLevel3_2021-03.gmt")
